          ...
          <div class="mt-10">
            ...
            <div class="mt-4">
              <ul role="list" class="list-disc space-y-2 pl-4 text-sm">
                ...
                <li class="text-gray-400"><span class="text-gray-600">Model: {data.post.carModel}</span></li>
                <li class="text-gray-400"><span class="text-gray-600">Motor: {data.post.carMotor}</span></li>
                <li class="text-gray-400"><span class="text-gray-600">Drivmiddel: {data.post.carType}</span></li>
                <li class="text-gray-400"><span class="text-gray-600">Første registrering: {convertDateString(data.post.carFirstRegistration)}</span></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <footer class="flex justify-between items-center mb-2">
        <div class="flex items-center">
          ...
          <p class="text-sm text-gray-600">
            {convertDateString(comment.createdAt)}
          </p>
        </div>
